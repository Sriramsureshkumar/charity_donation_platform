          ...
          <div className="mt-2 relative rounded-lg container mx-auto flex flex-col items-center pt-12 sm:pt-24 pb-24 sm:pb-32 md:pb-48 lg:pb-56 xl:pb-64">
            <div className="mt-8 w-11/12 sm:w-2/3 mb-5 sm:mb-10">
              <h1
                ...
                className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-center text-black font-bold leading-tight"
              >
                Value your verity
              </h1>
              <h5 className="text-lg text-center text-black font-bold leading-tight py-2">
                {" "}
